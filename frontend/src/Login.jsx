...
function Login(){
    ...
    const handeleSubmit=(e)=>{e.preventDefult()
    ...
    <div className="bg-white p-3 rounded w-25">
        ...
        <form onSubmit={handeleSubmit}>
            ...
            <div className="mb-3">
                ...
                <input type="text" placeholder=" EnterEmail" autoComplete="off" name="email" className="form-control rounded-0"onChange={(e) => setEmail(e.target.value)}  />
            </div>
            ...
            <button type="submit" className="btn btn-success w-100 bg-light rounded-0"> Register</button>
        </form>
        <p> Already Have an Account</p>

        <Link to="./login" className="btn btn-success w-100 bg-light rounded-0"> Login</Link>
